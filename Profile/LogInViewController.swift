...
//  Navigation
//
//  Created by Oleg Stepanov on 14.04.2026.
//
...
class LogInViewController: UIViewController {
    ...
    private let logoImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "Logo") ?? UIImage(systemName: "person.crop.circle.fill")
    ...
    private let logInButton: UIButton = {
        ...
        button.backgroundColor = UIColor(red: 72/255.0, green: 133/255.0, blue: 204/255.0, alpha: 1.0)
